...
namespace FGCIJOROSystem.Common
{
    ...
    {
        	//Defaults:
	//Must be on module level
	//Dim passPhrase As String = "*****"        ' can be any string
	//Dim initVector As String = "@1B2c3D4e5F6g7E1" ' must be 16 bytes
	...
	// </remarks>
	public Encryptor(string passPhrase) : this(passPhrase, null)
	{
	}
	...
	// in secret.
	// </param>
	public Encryptor(string passPhrase, string initVector) : this(passPhrase, initVector, -1)
	{
	}
	...
	// bytes).
	// </param>
	public Encryptor(string passPhrase, string initVector, int minSaltLen) : this(passPhrase, initVector, minSaltLen, -1)
	{
	}
	...
	// </param>
	public Encryptor(string passPhrase, string initVector, int minSaltLen, int maxSaltLen) : this(passPhrase, initVector, minSaltLen, maxSaltLen, -1)
	{
	}
	...
	// </param>
	public Encryptor(string passPhrase, string initVector, int minSaltLen, int maxSaltLen, int keySize) : this(passPhrase, initVector, minSaltLen, maxSaltLen, keySize, null)
	{
	}
	...
	// </param>
	public Encryptor(string passPhrase, string initVector, int minSaltLen, int maxSaltLen, int keySize, string hashAlgorithm) : this(passPhrase, initVector, minSaltLen, maxSaltLen, keySize, hashAlgorithm, null)
	{
	}
	...
	// can be any string.
	// </param>
	public Encryptor(string passPhrase, string initVector, int minSaltLen, int maxSaltLen, int keySize, string hashAlgorithm, string saltValue) : this(passPhrase, initVector, minSaltLen, maxSaltLen, keySize, hashAlgorithm, saltValue, 1)
	{
	}
    ...
    public Encryptor(string passPhrase, string initVector, int minSaltLen, int maxSaltLen, int keySize, string hashAlgorithm, string saltValue, int passwordIterations)
	{

...
{
    /// <summary>
    /// Summary description for rptTariffByEquipment.
    /// </summary>
    public partial class rptTariffByEquipmentJO : Telerik.Reporting.Report
    {
        decimal totalAmount = 0.00M;
        public rptTariffByEquipmentJO(List<clsTariffEqJO> ListOfTariffEq, string PreparedBy, string PreparedByPos, bool isDate, DateTime dateFrom, DateTime dateTo)
        {
            //
            // Required for telerik Reporting designer support
            //
            InitializeComponent();
            this.objTariffEqSummary.DataSource = ListOfTariffEq.ToList();
            ...
            if (isDate)
            {
                ...
                textBox9.Value = "Date Range: " + dateFrom.ToShortDateString() + " - " + dateTo.ToShortDateString(); 
            }
            else
            {
            ...
            foreach (var item in ListOfTariffEq)

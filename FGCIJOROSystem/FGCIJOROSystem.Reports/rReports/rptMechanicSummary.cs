namespace FGCIJOROSystem.Reports.rReports
{
    ...
    using System.Linq;
    /// <summary>
    /// Summary description for rptMechanicSummary.
    /// </summary>
    public partial class rptMechanicSummary : Telerik.Reporting.Report
    {
        public rptMechanicSummary(List<clsJOROReports> ListOfJOROReports, string filterBy, string PreparedBy, string PreparedByPos)
        {
            //

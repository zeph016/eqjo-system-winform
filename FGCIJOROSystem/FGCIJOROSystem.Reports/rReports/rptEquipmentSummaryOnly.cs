namespace FGCIJOROSystem.Reports.rReports
{
    ...
    using System.Linq;
    /// <summary>
    /// Summary description for rptEquipmentSummaryOnly.
    /// </summary>
    public partial class rptEquipmentSummaryOnly : Telerik.Reporting.Report
    {
        public rptEquipmentSummaryOnly(List<clsJOROReports> ListOfJOROReports, string filterBy, string PreparedBy, string PreparedByPos)
        {
            //

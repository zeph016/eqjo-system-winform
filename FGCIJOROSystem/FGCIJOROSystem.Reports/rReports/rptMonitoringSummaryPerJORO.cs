namespace FGCIJOROSystem.Reports.rReports
{
    ...
    /// <summary>
    /// Summary description for rptMonitoringSummaryPerJORO.
    /// </summary>
    public partial class rptMonitoringSummaryPerJORO : Telerik.Reporting.Report
    {
        public rptMonitoringSummaryPerJORO(List<clsMonitoring> ListOfMonitoring, string PreparedBy, string PreparedByPos, string FilterBy)
        {
            //

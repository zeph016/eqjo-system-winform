namespace FGCIJOROSystem.Reports.rAttendance
{
    ...
    /// </summary>
    public partial class rptCutOffAttendance : Telerik.Reporting.Report
    {
        public rptCutOffAttendance()
        {
            //
        ...
        public rptCutOffAttendance(List<clsAttendance> ListOfAttendance, String PreparedBy, DateTime DateOfUpdateFrom, string PreparedByPos, DateTime DateOfUpdateTo, string FilterBy)
        {
            //
            // Required for telerik Reporting designer support
            //

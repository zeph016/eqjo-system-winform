namespace FGCIJOROSystem.Reports.rAttendance
{
    ...
    /// </summary>
    public partial class rptCutOffAttendanceStatus : Telerik.Reporting.Report
    {
        public rptCutOffAttendanceStatus()
        {
            //
        ...
        public rptCutOffAttendanceStatus(List<clsAttendance> ListOfAttendance, String PreparedBy, DateTime DateOfUpdateFrom, string PreparedByPos, DateTime DateOfUpdateTo, string FilterBy)
        {
            //
            // Required for telerik Reporting designer support
            //

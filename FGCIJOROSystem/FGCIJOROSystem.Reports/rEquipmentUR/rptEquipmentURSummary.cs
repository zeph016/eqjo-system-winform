namespace FGCIJOROSystem.Reports.rEquipmentUR
{
    ...
    using System.Linq;
    /// <summary>
    /// Summary description for rptEquipmentURSummary.
    /// </summary>
    public partial class rptEquipmentURSummary : Telerik.Reporting.Report
    {
        public rptEquipmentURSummary(List<clsEquipmentUR> ListOfEquipmentUR, String FilterBy, string PreparedBy, string PreparedByPos)
        {
            //

...
using FGCIJOROSystem.Domain.Configurations.Users;
    ...
    /// </summary>
    public partial class rptJOROPRSList : Telerik.Reporting.Report
    {
        public rptJOROPRSList()
        {
            //
        ...
        public rptJOROPRSList(List<clsJOROPRS> ListOfJOROPRS, String Title, clsUser PreparedBy)
        {
            //
            // Required for telerik Reporting designer support
            //
